...
$sql="select * from employee where ssn=625251";
$result=mysqli_query($connect,$sql);
$sql1="select * from working_time where ssn=625251";
$result1=mysqli_query($connect,$sql1);
$sql2="select * from department where ssn=625251";
$result2=mysqli_query($connect,$sql2);
$sql3="select * from salary where ssn=625251";
$result3=mysqli_query($connect,$sql3);
$sql4="select * from project where ssn=625251";

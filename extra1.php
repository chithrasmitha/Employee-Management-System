...
$sql="select * from employee where ssn=672562";
$result=mysqli_query($connect,$sql);
$sql1="select * from working_time where ssn=672562";
$result1=mysqli_query($connect,$sql1);
$sql2="select * from department where ssn=672562";
$result2=mysqli_query($connect,$sql2);
$sql3="select * from salary where ssn=672562";
$result3=mysqli_query($connect,$sql3);
$sql4="select * from project where ssn=672562";
